...
import { getSchedule, User, getChallenges } from '../services';
...
function ChallengeHome(props) {
	...
	const loadInitialDetails = () => {
		...
		promises.push(getChallenges(props.renderProps.match.params.id));
		...
		<div className='h-full w-full overflow-hidden'>
			{loading ? (
				...
				<div className='h-full flex flex-col bg-no-repeat bg-cover bg-gray-50 overflow-hidden'>
					...
					<ThemedBackgroundWrapper className='w-full flex-1 p-4 block justify-center items-center bg-background  overflow-auto'>
						{challenges.map((ch, chi) => {
							return (
								<div
